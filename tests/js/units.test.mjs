...
const CN_CASES = [
  ...
  [99999, '10万'],           // 进位保护
  [100000, '10万'],
  [999999, '100万'],         // 进位保护：99.9999 → 100
  [1234567, '123.46万'],
  [12345678, '1234.57万'],
  [123456789, '1.23亿'],
  [987654321, '9.88亿'],
  [1000000000, '10亿'],
  [123456789012, '1234.57亿'],
  [1234567890123, '12345.68亿'],
];
...
test('非法模式回落中文单位', () => {
  assert.equal(formatCompact(12345678, undefined), '1234.57万');
  assert.equal(formatCompact(12345678, 'BOGUS'), '1234.57万');
  assert.equal(formatCompact(12345678, null), '1234.57万');
});
