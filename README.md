...
- **Token 显示口径**：**中文单位**（万亿 / 亿 / 千万 / 百万 / 万，不足一万显示原数，如 `2.48亿`、`97.83万`、`7719`）、**英文单位**（`247.51M`）、**原始数字**（`247,506,388`）三种（设置页切换）；未显式设置时随界面语言派生（中文界面 → 中文单位，English → 英文单位）
...
tests/                   pytest 单元测试 + tests/js（Node）数字单位格式化测试
